...
export default async function handler(req, res) {
    ...
    console.log("Putting into db:", videoUrl, language, summarize, user.email, output, queryIndexId, queryVideoId, videoTitle);
    await collection.insertOne({ videoUrl, language, summarize, user: user.email, output: output, queryIndexId, queryVideoId, videoTitle });
